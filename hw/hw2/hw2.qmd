...
execution_time <- system.time({
  ...
  filtered_data <- tbl(con, "labevents") %>%
    ...
    mutate(charttime = as.POSIXct(charttime, format="%Y-%m-%d %H:%M:%S", tz="UTC")) %>%  # Convert charttime to UTC
    arrange(subject_id, charttime)  # Arrange the data by subject_id and charttime
